...
The plugin is now updated to work with Zotero 9 (formerly Zotero 7.1) but support has been dropped for Zotero 6 and 7.0. As a result download the appropriate release below:

- Version 8/9 - [latest release](https://github.com/inciteful-xyz/inciteful-zotero-plugin/releases/latest/download/inciteful-zotero-plugin.xpi)
